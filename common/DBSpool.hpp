...
class DBSpool
{
    public:
        ...
        */
        int ExecuteSQL(const string& strSQL, MYSQL_RES** res, short& shIdentifier, int& iRelt);
        int ExecuteSQL(const char* pcSQL, MYSQL_RES** res, short& shIdentifier, int& iRelt);
        ...
        /*
          ...
          SQL_TYPE_UNKNOW while execute false, otherwise execute success.
        */
        int ExecuteSQL(const string& strSQL, RESDataList* res, int& iRelt);
        int ExecuteSQL(const char* pcSQL, RESDataList* res, int& iRelt);
        //lock
        void Lock();
        //unlock
        void Unlock();
