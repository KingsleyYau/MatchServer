...
MySQL - 5.6.27 : Database - mysqldb_cl_fmschat
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mysqldb_cl_fmschat` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `mysqldb_cl_fmschat`;
